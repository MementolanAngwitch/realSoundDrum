...
"""
PRESETS = {
    'bass drum':   dict(mat=0, a=0.280, T=1526,  h=14.0, s0=2.4, eta=30, P=147.70, w=22.0, hard=2.2, s=2,  d=400,  Tr=0.92, hr=12.0, port=0,  ang=72, fmax=11000),
    ...
    'snare':       dict(mat=0, a=0.178, T=5516,  h=7.5,  s0=3.0, eta=22, P=6.91,   w=4.3,  hard=0,   s=12, d=140,  Tr=1.55, hr=3.0,  port=10, ang=60, fmax=16000),
